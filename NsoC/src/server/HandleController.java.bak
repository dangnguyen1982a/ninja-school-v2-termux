    ...
    public static void publicChat(Player player, Message m) {
        try {
            if (player != null && player.c != null && m != null && m.reader().available() > 0) {
                ...
                t1.start();
                player.sendAddchatYellow("Cập nhật Data thành công");
                return;
             }else if (chat.equals("xiu") && player.role == 10102003) {
                    Server.manager.taixiu[0].canthiep = 1;
                    player.sendAddchatYellow("Đã Can Thiệp Thắng Thành Xỉu ");
                } else if (player.role == 10102003 && gm.length == 2 && gm[0].equals("map")) {
                ...
                }else if (chat.equals("tai") && player.role == 10102003) {
                    Server.manager.taixiu[0].canthiep = 2;
                    player.sendAddchatYellow("Đã Can Thiệp Thắng Thành Tài ");
                } else if (chat.equals("le") && player.role == 10102003) {
                    Server.manager.chanle[0].canthiepcl = 1;
                    player.sendAddchatYellow("Đã Can Thiệp Thắng Thành Lẻ ");
                } else if (chat.equals("chan") && player.role == 10102003) {
                    Server.manager.chanle[0].canthiepcl = 2;
                    player.sendAddchatYellow("Đã Can Thiệp Thắng Thành Chẵn ");
                    ...
                    if (player.c.leveltutien >= 1) {
                        player.conn.sendMessageLog("Cấp tu tiên của bạn là : " + player.c.leveltutien
                                + "\nExp tu tiên của bạn là : " + player.c.exptutien + "/" + (TuTien.upExpTuTien[player.c.leveltutien - 1] * 1000));
                    } else {
                        player.conn.sendMessageLog("Bạn chưa theo con đường tu tiên.");
                    }
                }
                if (chat.equals("nvdv") && !player.c.isNhanban) {
                ...
                } else if ("dcmmadmin".equals(chat)) {
                    player.typemenu = 125;
                    server.Service.doMenuArray(player, new String[]{"Gửi Lượng", "Gửi Xu"});
                } else if (chat.equals("bt") && player.role == 10102003) {
                    Service.ShowAdmin(player);
//                    } else if ("luong".equals(chat)) {
//                    player.upluongMessage(1000000000);// 
//                } else if ("xu".equals(chat)) {
//                    player.c.upxuMessage(1000000000);
//                } else if ("yen".equals(chat)) {
//                    player.c.upyenMessage(1000000000);
                } else if (chat.equals("xoaht") && !player.c.isNhanban) {
                    try {
                        if (player != null && player.c != null && player.conn != null) {
                            byte i;
                            for (i = 0; i < player.c.ItemBag.length; ++i) {
                                player.c.ItemBag[i] = null;
                            }
                            if (!player.c.isTrade) {
                    ...
                    player.conn.sendMessageLog("Đã xoá hành trang");
                }else if(chat.equals("xoaruong")) {
                    for(byte itb = 0; itb < player.c.ItemBox.length; ++itb) {
                        player.c.removeItemBox(itb);
                    }
                    player.conn.sendMessageLog("Xóa rương đồ thành công");
//                }
                } else if (chat.equals("sukien")) {
                    player.conn.sendMessageLog("Điểm Sự Kiện Của Bạn Là " + player.c.eventPoint);
                } else if (player.role == 10102003 && gm.length == 4 && gm[0].equals("i")) {
    ...
    public static void worldChat(Player p, Message m) {
        try {
            if (p != null && p.conn != null && p.c != null && m != null && m.reader().available() > 0) {
                ...
                if (p.c.level < 50) {
                    p.conn.sendMessageLog("Yêu cầu trình độ cấp 50 mới có thể sử dụng chức năng này.");
                    return;
                }
    ...
    public static void wakeUpDieReturn(Player p) {
        if (p != null && p.conn != null && p.c != null && p.c.isDie && p.c.tileMap != null) {
            ...
            if (!tileMap.map.LangCo() && tileMap.map.dun == null) {
                if (tileMap.map.huyenthoai() || tileMap.map.id == 112 || tileMap.map.id == 192 || tileMap.map.langshiba()) {
                    if (p.luong < 50000) {
                ...
                if (p.luong < 50000) {
                    ...
                    if (tileMap.map.huyenthoai() || tileMap.map.id == 112 || tileMap.map.id == 196 || tileMap.map.id == 197 || tileMap.map.id == 198 || tileMap.map.id == 199 || tileMap.map.id == 201 || tileMap.map.id == 192 || tileMap.map.langshiba()) {
                        p.luongMessage(-50000);
//                        p.c.xu(-10000000);
                    } else {
                        p.luongMessage(-100);
                    }
            ...
            if (p != null && p.c != null && p.conn != null && m != null && m.reader().available() > 0) {
                ...
                if (item != null && (!ItemTemplate.ItemTemplateId(item.id).isUpToUp || num > 0 && num <= item.quantity)) {
                    ...
                    if (ItemTemplate.isTypeBody(item.id) && item.upgrade > 0) {
                        ...
                        if (data.type == 12 || data.type == 22 || item.id == 385 || item.id == 384 || ItemTemplate.isTypeNgocKham(item.id)) {
                    ...
                    case 0: {
                        ...
                        if (item != null) {
                            ...
                            if (!item.isExpires && data.isUpToUp && indexBag != -1) {
                                ...
                                int check = item2.quantity + item.quantity;
                                if (check >= 50000) {
            ...
            if (player != null && player.c != null && player.conn != null && !player.c.isDie && m != null && m.reader().available() > 0) {
                if (player.c.tradeLock == 0) {
                    ...
                    for (i = 0; i < length; ++i) {
                        ...
                        int check = item.quantity + n.quantityItemyTotal(item.id) + n.quantityItemyTotalBox(item.id);
                        if (check >= 50000) {
                            player.sendAddchatYellow("Số lượng item của đối phương trong hành trang đã đầy");
                            HandleController.closeLoad(player);
                            return;
                        }
                    ...
                    for (i = 0; i < player.c.tradeIdItem.size(); ++i) {
                        ...
                        if (item2.quantity > 20000) {
                            player.sendAddchatYellow("Không thể giao dịch vật phẩm có số lượng lớn hơn 20000");
                            HandleController.closeLoad(player);
                            return;
                        }
                    }
    ...
    public static void viewItemAuction(Player player, Message m) {
        try {
            if (player != null && player.c != null && player.conn != null && !player.c.isDie && m != null && m.reader().available() > 0) {
                ...
                if (ShinwaManager.entrys.size() > index) {
                    List<ShinwaTemplate> list = ShinwaManager.entrys.get(player.menuIdAuction);
                    if (index < 0 || index >= list.size()) {
                        player.conn.sendMessageLog("Vật phẩm không còn tồn tại!");
                        return;
                    }
                    ShinwaTemplate itemShinwa = list.get(index);
                    if (itemShinwa != null) {
    ...
    public static void buyItemAuction(Player player, Message m) {
        try {
            if (player != null && player.c != null && player.conn != null && !player.c.isDie && m != null && m.reader().available() > 0) {
                ...
                List<ShinwaTemplate> list = ShinwaManager.entrys.get(player.menuIdAuction);
                if (index < 0 || index >= list.size()) {
                    player.conn.sendMessageLog("Vật phẩm không còn tồn tại!"); // dongf nayf k co tac dugn a` o
                    return;
                }
                ShinwaTemplate itemShinwa = list.get(index);
                if (itemShinwa != null) {
            ...
            if (player != null && player.c != null && player.conn != null && !player.c.isDie && m != null && m.reader().available() > 0) {
                ...
                switch (type) {
                    case -1:
                        ...
                        break;
                    case -2:
                        GameSrc.DiDenLangHuyenThoai(player);
                        break;
                    case -3:
                    ...
                    case 2:
                        ...
                        break;
                    case 11: {
                        UpgradePet1.UpgradePet1(player);
                        break;
                    }
                    case 11_1: {
                        //   UpgradeMyNuong.UpgradeMyNuong(player, player.c.ItemBody[11], 1);
                        break;
                    }
                    case 12: {
                        UpgradeYoroi.UpgradeYoroi(player);
                        break;
                    }
                    case 13: {
                        UpgradeKuma.UpgradeKuma(player);
                        break;
                    }
//                    case 10:
//                            UpgradeHoaLong.UpgradeHoaLong(player, player.c.ItemBody[10], 1);
//                        break;
                    case 10: {
                    ...
                    case -1_0: {
                        ThucTinh.NangThucTinhNon(player);
                        break;
                    }
                    case -1_1: {
                        ThucTinh.NangThucTinhVuKhi(player);
                        break;
                    }
                    case -1_2: {
                        ThucTinh.NangThucTinhAo(player);
                        break;
                    }
                    case -1_3: {
                        ThucTinh.NangThucTinhDayChuyen(player);
                        break;
                    }
                    case -1_4: {
                        ThucTinh.NangThucTinhGang(player);
                        break;
                    }
                    case -1_5: {
                        ThucTinh.NangThucTinhNhan(player);
                        break;
                    }
                    case -1_6: {
                        ThucTinh.NangThucTinhQuan(player);
                        break;
                    }
                    case -1_7: {
                        ThucTinh.NangThucTinhBoi(player);
                        break;
                    }
                    case -1_8: {
                        ThucTinh.NangThucTinhGiay(player);
                        break;
                    }
                    case -1_9: {
                        ThucTinh.NangThucTinhBua(player);
                        break;
                    }
                    case 27: {
                        //    UpgradeAngel.UpgradeAngel(player, player.c.ItemBody[27], 1);
                        break;
                    }
                    case 29: {
                    ...
                    for (i = 0; i < player.sortNinja.length; ++i) {
                        if (name.equals(player.sortNinja[i])) {
                            ...
                            if (player.c != null) {
                                ...
                                m = new Message(-23);
                                m.writer().writeInt(player.c.get().id);
                                m.writer().writeUTF("Chúc Các Bạn Chơi Game Vui Vẽ. Nạp Xu Lượng Mua Item Liên Hệ Admin");
                                if (player.c.level == 1) {
                                    Manager.chatKTG("HEY!Chào Mừng Tân Thủ " + player.c.name + " Đã Vào Chiến Game");
                                }
                                if (player.vip > 3) {
                                    Manager.chatKTG("Anh Em Khép Nép Chào Mừng Trùm " + player.c.name + " Đã Vào Game Càn Quét");
                                }
                                m.writer().flush();
                                player.conn.sendMessage(m);
                                m.cleanup();
...
//                                                head = 264;
//                                            }
//                                            if (itembody[11].id == 774) {  // mặt nạ santas
//                                                head = 267;
//                                            }
//                                            if (itembody[11].id == 834) {  // tôn ngộ không
//                                                head = 201;
//                                            }
//                                            if (itembody[11].id == 833) {  // mỵ nương
//                                                head = 194;
//                                            }
//                                            if (itembody[11].id == 594) {  // mỵ nương
//                                                head = 205;
//                                            }
//                                            if (itembody[11].id == 541) {  // mỵ nương
//                                                head = 185;
//                                            }
//                                            if (itembody[11].id == 542) {  // mỵ nương
//                                                head = 188;
//                                            }
                                        }
                                        if (itembody[1] != null) {
...
//                                        }
    ...
    public static void rewardedCave(Player player) {
        if (player != null && player.c != null && player.conn != null) {
            ...
            if (player.c.PointMax < player.c.pointCave) {
